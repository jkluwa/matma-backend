...
6. **🏆 The Finish (WIP):** Players race to solve the task first. *(Answer submission is currently under development).*
...
### 2. Build & Run
Spin up the entire environment (API + Database) with a single command:
```bash
